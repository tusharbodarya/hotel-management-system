...
jQuery(document).ready(function($) {
	...
	$("#color_switcher_preview .stylesheet" ).click(function(){
		$("#colors" ).attr("href", "/static/css/style.css" );
		return false;
	});

	$("#color_switcher_preview .stylesheet_1" ).click(function(){
		$("#colors" ).attr("href", "/static/css/colors_version/stylesheet_1.css" );
		return false;
	});
	
	$("#color_switcher_preview .stylesheet_2" ).click(function(){
		$("#colors" ).attr("href", "/static/css/colors_version/stylesheet_2.css" );
		return false;
	});
	
	$("#color_switcher_preview .stylesheet_3" ).click(function(){
		$("#colors" ).attr("href", "/static/css/colors_version/stylesheet_3.css" );
		return false;
	});
	
	$("#color_switcher_preview .stylesheet_4" ).click(function(){
		$("#colors" ).attr("href", "/static/css/colors_version/stylesheet_4.css" );
		return false;
	});
	
	$("#color_switcher_preview .stylesheet_5" ).click(function(){
		$("#colors" ).attr("href", "/static/css/colors_version/stylesheet_5.css" );
		return false;
	});
	
	$("#color_switcher_preview .stylesheet_6" ).click(function(){
		$("#colors" ).attr("href", "/static/css/colors_version/stylesheet_6.css" );
		return false;
	});	
